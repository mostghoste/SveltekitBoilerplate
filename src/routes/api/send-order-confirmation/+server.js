...
const translations = {
	en: {
		email: {
			// For Customer Email
			greeting:
				'Dear Partner,<br/><br/>Thank you for your order!<br/>Our sales team will contact you shortly.',
	...
	lt: {
		email: {
			// For Customer Email
			greeting:
				'Laba diena,<br/><br/>Jūsų užsakymas gautas!<br/>Susisieksime su jumis artimiausiu metu.',
			...
			if_questions:
				'Jei turite klausimų, prašome kreiptis į jūsų aptarnaujantį pardavimų vadybininką.',
	...
	ru: {
		email: {
			...
			if_questions:
				'Пожалуйста, обращайтесь к вашему менеджеру по продажам, если у вас есть вопросы.',
